# #' 3D surface of a 9-mm Glock firing pin aperture shear.
# #'
# #' A dataset containing the z-heights (in micro meters) of a 
# #' retangular portion of a firing pin aperture shear on a fired
# #' cartrige case. This 3D data is in the form of a Digital Surf
# #' MountainsMap 5 .sur file.
# #'
# #' @format A 512-byte header of information about the surface followed by
# #' a 1D array of data. Reformated the data is a matrix with XXXX rows and 
# #' XXXX columns.
# #' \describe{
# #'   \item{code}{}
# #'   \item{format}{}
